import { ThemeProvider, CssBaseline, AppBar, Toolbar, Typography, Button, Container, IconButton } from '@mui/material';
        ...
        <Container sx={{
          ...
          pt: '64px',
              ...
              <Routes location={location} key={location.pathname}>
                ...
                <Route path="/blog/:id" element={<ErrorBoundary><BlogPost /></ErrorBoundary>} /> {/* Wrap BlogPost with ErrorBoundary */}
